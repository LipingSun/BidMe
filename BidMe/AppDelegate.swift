...
//        AVOSCloud.setApplicationId("tH1AMIWd6vHGSLO5Jn5EaBC7", clientKey: "TC1mHol4exEP8InB59m0u8ct")
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "edu.sjsu.cmpe277.project.BidMe" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("BidMe", withExtension: "momd")!
