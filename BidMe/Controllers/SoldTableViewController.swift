...
class SoldTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cellIdentifier = "SoldTableViewCell"
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifier, forIndexPath: indexPath)
            as! SoldTableViewCell
        let product = products[indexPath.row]
        
        // Configure the cell...
        cell.nameLabel.text = product.name
        cell.productPic.image = product.photo
        cell.dateLabel.text = "Sold Time: "+product.endTime!
        cell.priceLabel.text = "Sold Price: $"+String(product.myPrice)
        return cell
